...
extension AppsVC {
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        guard let header = collectionView.dequeueReusableSupplementaryView(ofKind: AppsHeader.king, withReuseIdentifier: AppsHeader.identifier, for: indexPath) as? AppsHeader
            else { fatalError("No header found")}
        return header
    }
